        ...
        <div className='bg-dark'>
            <div class="container">
                <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 mt-5 border-top">
                    <div class="col mb-3">
                    <NavLink to="/" class="d-flex align-items-center mb-3 lead text-bolder text-light text-decoration-none">
                        E-Commerce
                    </NavLink>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><NavLink to="#" class="nav-link p-0 text-muted text-decoration-none">Home</NavLink></li>
